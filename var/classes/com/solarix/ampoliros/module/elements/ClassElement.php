 ...
 *
 */
// $Id: ClassElement.php,v 1.4 2004-07-08 15:04:27 alex Exp $

package('com.solarix.ampoliros.module.elements');

import('com.solarix.ampoliros.module.ModuleElement');

class ClassElement extends ModuleElement {
	public $type = 'class';
	public $site = false;

	function ClassElement($ampdb, $sitedb, $modname, $name, $file, $basedir) {
