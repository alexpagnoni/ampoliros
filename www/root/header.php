 ...
 *
 */
// $Id: header.php,v 1.13 2004-07-08 15:04:24 alex Exp $
...
$hui_page = new HuiPage('page', array('title' => 'Ampoliros'. (strlen(AMP_NAME) ? ' - '.AMP_NAME. (strlen(AMP_DOMAIN) ? '.'.AMP_DOMAIN : '') : ''), 'border' => 'false'));
...
$hui_mainvertgroup -> AddChild(new HuiButton('amplogo', array('action' => AMP_URL, 'target' => '_top', 'image' => $hui_page -> mThemeHandler -> mStyle['middot'], 'highlight' => 'false', 'highlight' => 'false')));
