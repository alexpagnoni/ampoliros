 ...
 *
 */
// $Id: index.php,v 1.9 2004-07-08 15:04:24 alex Exp $
 
require( "./auth.php" );
OpenLibrary( 'hui.library' );

if ( strlen( $_SESSION['AMPROOT_AUTH_USER'] ) )
{
    OpenLibrary( 'sessionkey.hui', HANDLER_PATH );

$empty = new HuiSessionKey( 'mainpage', array( 'sessionobjectnopage' => 'true' ) );
if ( !strlen( $empty->mValue ) ) $main_page_url = 'main.php';
else
{
...
<html>
<head>
<title>Ampoliros root - <?php echo AMP_HOST; ?></title>
...
<frameset cols="150,*" framespacing="0" border="0" frameborder="0">
	...
	<frame name="groupop" src="<?php echo $main_page_url; ?>" noresize>
	<noframes>
		<body>
